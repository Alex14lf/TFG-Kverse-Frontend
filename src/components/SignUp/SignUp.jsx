    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setErrors(data.errors || {});  // Establecemos los errores del backend
        ...
        <>
            ...
            <div className="container__register">
                ...
                <form className="container__form" onSubmit={handleSubmit}>
                    ...
                    {errors.email && <p className="error-message">{errors.email}</p>} {/* Mostramos error aquí */}
                    ...
                    {errors.dni && <p className="error-message">{errors.dni}</p>} {/* Mostramos error aquí */}
                    ...
                    <div className="containerflex">
                        <div className="containercolumn">
                            ...
                            {errors.nombre && <p className="error-message">{errors.nombre}</p>} {/* Mostramos error aquí */}
                        </div>
                        <div className="containercolumn">
                            ...
                            {errors.apellidos && <p className="error-message">{errors.apellidos}</p>} {/* Mostramos error aquí */}
                        </div>
                    </div>
                    ...
                    <div className="containerflex">
                        <div className="containercolumn">
                            ...
                            {errors.telefono && <p className="error-message">{errors.telefono}</p>} {/* Mostramos error aquí */}
                        </div>
                        <div className="containercolumn">
                            ...
                            {errors.fecha_nacimiento && <p className="error-message">{errors.fecha_nacimiento}</p>} {/* Mostramos error aquí */}
                        </div>
                    </div>
                    ...
                    {errors.password && <p className="error-message">{errors.password}</p>} {/* Mostramos error aquí */}
